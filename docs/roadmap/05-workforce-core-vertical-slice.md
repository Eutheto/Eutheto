...
- The required-obligation universe is every active authored rule, every person activity fact, every approved-PTO fact and every Hard lock. Contributions return sorted disjoint handled/remaining partitions. Unsupported active families and Hard locks remain explicit; hard-lock readiness is not their enforcement. Minimum-rest conflicts remain WF-004.
