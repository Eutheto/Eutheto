...
**Phase 06 exception (24 September 2026):** The maintainer chose agent-operated native testing of typical mouse/keyboard interactions during development and deferred unfamiliar solver-naive participant research and spoken native screen-reader QA to beta. The deferred checks remain **unverified**, not passed; Phase 12's QA-RESEARCH and QA-A11Y gates must collect them before public release. This does not waive implemented keyboard/list/semantic accessibility, Phase 06's other acceptance criteria, or explicit user review and checkpoint acceptance. The user may review the [agent-operated Phase 06 record](06-desktop-design-system-and-workforce-setup.md#assisted-native-walkthrough--24-september-2026) instead of personally repeating its evidenced typical interactions; unexercised steps stay identified. All other checkpoint and release gates retain their original requirements.
...
3. Wait for the user's manual testing and feedback, or the specific Phase 06 agent-operated record and user review authorized above. Fix failures in the current phase and rerun affected automated and manual checks; do not treat untested or blocked checks as passes.
